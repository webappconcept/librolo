// app/(admin)/admin/preview/[id]/page.tsx
...
import { getLayoutComponent } from "../../(protected)/../../../(frontend)/_templates/registry";
import { parseStyleConfig, parseCustomFields } from "../../(protected)/../../../(frontend)/_templates/types";
