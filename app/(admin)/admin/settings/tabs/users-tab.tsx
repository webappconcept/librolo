// app/(admin)/admin/settings/tabs/users-tab.tsx
"use client";
...
export function UsersSettingsTab({
  ...
  return (
    <UsersSettingsTabInner key={pathname} settings={settings} roles={roles} />
  );
}

function UsersSettingsTabInner({
  settings,
  roles,
}: {
  settings: AppSettings;
  ...
  // Ruolo selezionato corrente (per anteprima colore)
  ...
  // Filtra i ruoli admin — non assegnabili automaticamente alla registrazione
